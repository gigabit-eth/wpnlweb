...
class Wpnlweb {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wpnlweb_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Wpnlweb_Loader. Orchestrates the hooks of the plugin.
	 ...
	 *
	 * Uses the Wpnlweb_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
